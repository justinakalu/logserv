...
{
    public partial class retirement_entry : System.Web.UI.Page
    {
        ...
        protected void submitpromotion(object sender, EventArgs e)
        {
            ...
            {
                DateTime actiondate = DateTime.Parse(dateofretirement.Value);
                ...
                cmd.Parameters.AddWithValue("@status", "Retired");
        ...
        {
            String query2 = "UPDATE Staff_Reg SET retired = @retired, dead = @dead, servingLGA_Chart = @servingLGA_Chart Where uuid = @uuid";
            ...
            cmd2.Parameters.AddWithValue("@retired", "Yes");
            cmd2.Parameters.AddWithValue("@dead", "No");
            ...
            if(result > 0)
            {
                string title = "Retirement submission was successful";
                string body = "Do you want to upload staff related documents such as retirement notice, e.t.c now?" +
