...
{
    public partial class promotion_entry : System.Web.UI.Page
    {
        ...
        protected void submitpromotion(object sender, EventArgs e)
        {
            ...
            {
                DateTime actiondate = DateTime.Parse(dateofpromotion.Value);
                ...
                cmd.Parameters.AddWithValue("@status", "Promoted");
        ...
        protected void upateRegTable()
        {
            ...
            if(result > 0)
            {
                string title = "Promotion submission was successful";
                string body = "Do you want to upload staff related documents such promotion letter, e.t.c now?" +
