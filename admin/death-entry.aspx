<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="death-entry.aspx.cs" Inherits="logserv.admin.death_entry" %>
...
<body class="horizontal-navigation">
                        ...
                        <div class="header-left">
                         ...
                         <div class="header-body">
                            <div class="header-body-left">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <div class="header-search-form bg-facebook">
                                            <%--<form>--%>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="#">Record Death</a></li>
                    ...
                    <div class="content-body">
                        ...
                        <div class="content">
                            ...
                            <div class="page-header">
                                <div>
                                    <h3>Staff Death Registration</h3>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Record Death</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div runat="server" id="staffDiv" visible="false">
                                                <div data-label="STAFF DETAILS" class="demo-code-preview">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><span>GENDER: </span><span style="margin-left: 10px">
                                                                <asp:Label ID="lblgender" runat="server" ForeColor="#999999"></asp:Label></span></p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Select Date of Death</label>
                                                            <input type="text" name="dateofdeath" runat="server" id="dateofdeath" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <br />
    ...
    <script>
        $('input[name="dateofdeath"]').daterangepicker({
            singleDatePicker: true,
            showDropdowns: true
        });
    </script>
