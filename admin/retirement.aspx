<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retirement.aspx.cs" Inherits="logserv.admin.retirement" %>
   ...
   <%-- <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#<%= retirementgrid.ClientID %>').DataTable({                
                responsive: true,
                dom: 'Bfrtip',
                buttons: [
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="#">Retirements</a></li>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Retired Staff</li>
                                            <li class="breadcrumb-item">
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                <span style="float: right"><a href="retirement-entry.aspx" class="nav-link" title="Add new record" data-toggle="tooltip">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <asp:GridView CssClass="table table-striped table-bordered" ID="retirementgrid" runat="server" DataKeyNames="staff_uuid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="long_activedate" HeaderText="Date Retired" />
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="Lnkdelete" runat="server" CssClass="text-danger ml-2" CommandArgument = '<%# Eval("staff_uuid") %>' CommandName="deleteretirement" data-toggle="tooltip" 
                                                                title="Delete" 
