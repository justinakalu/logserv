...
{
    public partial class transfer_entry : System.Web.UI.Page
    {
        ...
        protected void submitpromotion(object sender, EventArgs e)
        {
            ...
            {
                DateTime actiondate = DateTime.Parse(dateoftransfer.Value);
                DateTime now = DateTime.Now;
                string str1 = Server.HtmlEncode(editor.Text);
                ...
                cmd.Parameters.AddWithValue("@status", "Transferred");
        ...
        {
            String query2 = "UPDATE Staff_Reg SET servingLGA_Chart = @servingLGA_Chart Where uuid = @uuid";
            ...
            if(result > 0)
            {
                string title = "Transfer submission was successful";
                string body = "Do you want to upload staff related documents such as transfer letter, e.t.c now?" +
