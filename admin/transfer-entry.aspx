<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer-entry.aspx.cs" Inherits="logserv.admin.transfer_entry" %>
...
<body class="horizontal-navigation">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="#">Record Transfer</a></li>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Record transfer</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div runat="server" id="staffDiv" visible="false" >
                                                ...
                                                <div class="row">                                                    
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Select Transfered Date</label>
                                                            <input type="text" name="dateoftransfer" runat="server" id="dateoftransfer" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <br /><br />                                            
   ...
   <%-- For CKEditor--%>
    ...
    <script>
        $('input[name="dateoftransfer"]').daterangepicker({
            singleDatePicker: true,
            showDropdowns: true
        });
    </script>
