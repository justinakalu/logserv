<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="logserv.admin.Upload" %>
    ...
    <script type="text/javascript">       
        $(document).ready(function () {
            ...
            $('#btnsubmit').on('click', function (e) {
                ...
                {                    
                    ShowPopup2("WAIT!  YOU CANNOT CONTINUE", "kindly enter Document(s) Description.");
                }
                else if ($("#DDLFileNo")[0].selectedIndex <= 0)
                {
                    ShowPopup2("WAIT!  YOU CANNOT CONTINUE", "Please select staff File No. to proceed.");
                }
                else
                {                
                                ...
                                <div class="col-md-12">
                                    <div class="card">                                  
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Enter document(s) description(s) e.g. appointment, etc.</label>
                                                        <input runat="server" id="txtdescription" type="text" class="form-control" required="required" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div runat="server" id="staffDiv" visible="false" data-label="STAFF DETAILS" class="demo-code-preview">
                                               <div class="row">
                                                   <div class="col-md-6">
