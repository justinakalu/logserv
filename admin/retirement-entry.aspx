<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retirement-entry.aspx.cs" Inherits="logserv.admin.retirement_entry" %>
...
<head runat="server">
    ...
    <title>Staff retirement entry</title>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="#">Record Retirement</a></li>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Record retirement</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div runat="server" id="staffDiv" visible="false" >
                                                ...
                                                <div class="row">                                                    
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Select Retirement Date</label>
                                                            <input type="text" name="dateofretirement" runat="server" id="dateofretirement" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <br /><br />                                            
