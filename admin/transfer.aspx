<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer.aspx.cs" Inherits="logserv.admin.transfer" %>
   ...
   <%-- <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#<%= transfergrid.ClientID %>').DataTable({                
                responsive: true,
                dom: 'Bfrtip',
                buttons: [
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="transfer.aspx">Transfers</a></li>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Transferred Staff</li>
                                            <li class="breadcrumb-item">
                                            </li>
                                        </ol>
                                    </nav>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <asp:GridView CssClass="table table-striped table-bordered" ID="transfergrid" runat="server" DataKeyNames="staff_uuid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="long_activedate" HeaderText="Date of Transfer" />
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="Lnkdelete" runat="server" CssClass="text-danger ml-2" CommandArgument = '<%# Eval("id") %>' CommandName="deletetransfer" data-toggle="tooltip" 
                                                                title="Delete" 
