<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="death.aspx.cs" Inherits="logserv.admin.death" %>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="active" href="#">Deaths</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Deceased Staff</li>
                                            <li class="breadcrumb-item">
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                <span style="float: right"><a href="death-entry.aspx" class="nav-link" title="Add new record" data-toggle="tooltip">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <asp:GridView CssClass="table table-striped table-bordered" ID="deathgrid" runat="server" DataKeyNames="staff_uuid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="long_activedate" HeaderText="Date of Death" />
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="Lnkdelete" runat="server" CssClass="text-danger ml-2" CommandArgument = '<%# Eval("staff_uuid") %>' CommandName="deletedeath" data-toggle="tooltip" 
                                                                title="Delete" 
